...
/**
 * validated, isolated ArtiSynth inverse-tracking model for the canonical
 * mandibular mass-and-inertia rerun.
 *
 * <p>This class deliberately has a new name. It does not replace or overwrite
 * the earlier MandibleScalingInverseDDK class. Geometry is fixed; gravity is
...
public class MandibleScalingInverseDDK_CURRENT extends JawDemo {
   ...
   * JawDemo class, not relative to this project-specific subclass. The base
   * implementation passes {@code this} to ArtisynthPath, which makes an
   * isolated subclass resolve data/incisorForce below validated_classes.
   */
  @Override
